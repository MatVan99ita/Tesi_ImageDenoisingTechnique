...
\section{Prima run}
Il primo allenamento è stato sottoposto a entrambi i modelli con immagini RGB con risoluzione 112x112 pixel, un noise\_factor di 0.4 e 50 epoche di training ed entrambe con una batch_size di 64.\\
\subsection{Autoencoder}
\begin{table}[htbp]
  \centering
  \multicolumn{4}{|c|}{\rowcolor{greyo} \textbf{Model: "functional"}} \\
\begin{tabular}{|| c | c | c ||}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.75\textwidth]{autoencoder_psnr_2}
  \caption{First psnr of the autoencoder}
  \label{fig: Autoencoder: Media PSNR sul test set: 5.43 dB}
\end{figure}
...
\end{tabular}
 ...
 \begin{figure}[H]
  ...
  \caption{First psnr of the autoencoder}
  \label{fig: RIDNET: Media PSNR sul test set: 5.37 dB.}
\end{figure}
